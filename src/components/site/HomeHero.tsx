...
const COPY = {
    ...
    slides: [
      {
        ...
        title: ["明日的能源。", "就在今天。"],
        subtitle:
          "Eqnovia 为清洁能源的生产与储存提供全方位解决方案。",
      },
      {
        kicker: "",
        title: ["摩洛哥的阳光，", "成就您的雄心。"],
        subtitle:
          "我们设计并运营您的光伏电站，实现持久稳定的性能。",
      },
      {
        kicker: "",
        title: ["能源自主。", "全面安全。"],
        subtitle:
          "我们的储能系统确保您的电力供应连续可靠、坚韧稳健。",
      },
    ],
    cta1: "启动您的项目",
    cta2: "探索我们的服务",
  ...
  ar: {
    slides: [
      {
        kicker: "",
        title: ["طاقة الغد.", "اليوم."],
        subtitle:
          "تقدم Eqnovia حلولاً متكاملة لإنتاج وتخزين الطاقة النظيفة.",
      },
      {
        kicker: "",
        title: ["شمس المغرب،", "في خدمة طموحاتكم."],
        subtitle:
          "نصمم ونشغل محطاتكم الكهروضوئية لأداء دائم ومستدام.",
      },
      {
        kicker: "",
        title: ["استقلالية طاقية.", "أمان تام."],
        subtitle:
          "تضمن أنظمة التخزين لدينا استمرارية ومرونة إمداد الطاقة الخاص بكم.",
      },
    ],
    cta1: "أطلق مشروعك",
    cta2: "اكتشف خدماتنا",
