...
const COPY = {
  ...
  zh: {
    stats: [
      ...
      { value: "12", label: "位专职专家" },
      { value: "15+", label: "个已交付项目" },
      { value: "25 MW", label: "已安装并监控" },
    ],
    services: [
      {
        icon: LineChart,
        title: "研究与融资",
        desc: "能源审计、技术设计和为您的太阳能项目量身定制的融资方案。",
      },
      {
        icon: Wrench,
        title: "供货与安装",
        desc: "由我们经认证的团队精选最优设备并提供交钥匙安装服务。",
      },
      {
        icon: Cog,
        title: "运营与维护",
        desc: "24/7 监控，预防性和纠正性维护，确保长期性能表现。",
      },
    ],
    sectors: [
      { icon: Factory, label: "工业" },
      { icon: Building2, label: "服务业" },
      { icon: Tractor, label: "农业" },
      { icon: Hotel, label: "酒店业" },
      { icon: School, label: "教育" },
      { icon: HeartPulse, label: "医疗健康" },
    ],
    projects: [
      {
        img: projAgadir,
    ...
    solutions: [
      { icon: Sun, title: "工商业太阳能", desc: "面向工业和服务业的光伏电站。" },
      { icon: BatteryCharging, title: "储能系统", desc: "用于自主供电和保障用电安全的 BESS 系统。" },
    ],
    aboutKicker: "关于我们",
    aboutTitle: "服务于非洲工业的太阳能专业能力。",
    aboutDesc:
      "Eqnovia 由充满热情的工程师创立，陪伴摩洛哥和非洲企业完成能源转型——从研究到运营。",
    aboutList: [
      "认证工程师和技术人员",
      "端到端方案：研究、EPC、运营维护",
      "针对每种情况量身定制的结构化融资",
    ...
    aboutMore: "了解更多",
    aboutImgAlt: "Eqnovia 卡萨布兰卡项目",
    servicesKicker: "我们的服务",
    servicesTitle: "能源转型的三大支柱。",
    servicesMore: "了解更多",
    sectorsKicker: "我们的行业",
    sectorsTitle: "多行业专业能力。",
    sectorsDesc:
      "从重工业到公共机构，我们根据每种活动和现场限制调整解决方案。",
    projectsKicker: "标杆项目",
    projectsTitle: "切实的成果。",
    ...
    roiLbl: "投资回报率",
    explore: "探索",
    ctaTitle: "立即启动您的太阳能项目。",
    ctaDesc:
      "让我们谈谈您的场地、用电量和目标。我们将在 48 小时内回复初步评估。",
    ctaBtn: "立即开始",
  },
  ar: {
    stats: [
      { value: "+20", label: "عاماً من الخبرة" },
      { value: "12", label: "خبيراً متخصصاً" },
      { value: "+15", label: "مشروعاً منجزاً" },
      { value: "25 ميجاواط", label: "مُركّبة ومُراقبة" },
    ],
    services: [
      {
        icon: LineChart,
        title: "الدراسة والتمويل",
        desc: "تدقيق طاقي وتصميم تقني وهيكلة مالية مخصصة لمشروعكم الشمسي.",
      },
      {
        icon: Wrench,
        title: "التوريد والتركيب",
        desc: "اختيار أفضل المعدات وتركيب جاهز بالكامل من قبل فرقنا المعتمدة.",
      },
      {
        icon: Cog,
        title: "التشغيل والصيانة",
        desc: "إشراف على مدار الساعة، وصيانة وقائية وتصحيحية لضمان الأداء على المدى الطويل.",
      },
    ],
    sectors: [
      { icon: Factory, label: "الصناعة" },
      { icon: Building2, label: "القطاع الثالث" },
      { icon: Tractor, label: "الفلاحة" },
      { icon: Hotel, label: "الفندقة" },
      { icon: School, label: "التعليم" },
      { icon: HeartPulse, label: "الصحة" },
    ],
    projects: [
      {
        img: projAgadir,
        location: "أكادير، المغرب",
        title: "محطة على سطح صناعي",
        power: "1.2 ميجاواط ذروة",
        savings: "38%",
        roi: "5.2 سنوات",
      },
      {
        ...
        title: "مظلة شمسية لوجستية",
        power: "2.5 ميجاواط ذروة",
        savings: "42%",
        roi: "4.8 سنوات",
      },
    ],
    solutions: [
      { icon: Sun, title: "الطاقة الشمسية التجارية والصناعية", desc: "محطات كهروضوئية للصناعة والقطاع الثالث." },
      { icon: BatteryCharging, title: "تخزين الطاقة", desc: "أنظمة BESS لتحقيق الاستقلالية وتأمين التزود بالطاقة." },
    ],
    aboutKicker: "من نحن",
    aboutTitle: "خبرة في الطاقة الشمسية في خدمة الصناعة الأفريقية.",
    aboutDesc:
      "تأسست Eqnovia على يد مهندسين شغوفين، وترافق الشركات المغربية والأفريقية في تحولها الطاقي — من الدراسة إلى التشغيل.",
    aboutList: [
    ...
    aboutMore: "معرفة المزيد",
    aboutImgAlt: "مشروع Eqnovia الدار البيضاء",
    servicesKicker: "خدماتنا",
    servicesTitle: "ثلاث ركائز لتحولكم الطاقي.",
    servicesMore: "معرفة المزيد",
    sectorsKicker: "قطاعاتنا",
    sectorsTitle: "خبرة متعددة القطاعات.",
    sectorsDesc:
      "من الصناعة الثقيلة إلى المؤسسات العمومية، نُكيّف حلولنا مع كل نشاط وقيود كل موقع.",
    projectsKicker: "مشاريع رائدة",
    projectsTitle: "إنجازات ملموسة.",
    seeAllProjects: "عرض جميع المشاريع",
    power: "القدرة",
    savingsLbl: "التوفير",
    roiLbl: "العائد على الاستثمار",
    explore: "استكشاف",
    ctaTitle: "أطلقوا مشروعكم الشمسي الآن.",
    ctaDesc:
      "دعونا نتحدث عن موقعكم واستهلاككم وأهدافكم. سنرد عليكم خلال 48 ساعة بتقدير أولي.",
    ctaBtn: "ابدأ الآن",
  },
} as const;
