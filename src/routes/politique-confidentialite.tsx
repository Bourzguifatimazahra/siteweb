...
const COPY = {
  ...
  zh: {
    heading: "隐私政策",
    intro: "符合09-08号法律及以下机构的规定",
    cndpFull: "（个人数据保护监管国家委员会）。",
    s1Title: "1. 数据控制者",
    s1Body: "Eqnovia，总部位于摩洛哥卡萨布兰卡，负责处理通过本网站收集的个人数据。",
    s2Title: "2. 收集的数据",
    s2Item1: "联系表单：姓名、电子邮箱、电话、公司、留言内容。",
    s2Item2: "浏览数据：匿名化的IP地址、访问页面、访问时长。",
    s2Item3Prefix: "Cookies：请参阅我们的",
    s2Item3Link: "Cookie政策",
    s3Title: "3. 使用目的",
    s3Item1: "回应商业和技术咨询。",
    s3Item2: "改善用户体验和网站性能。",
    s3Item3: "在您同意的情况下发送资讯类通讯。",
    s4Title: "4. 法律依据",
    s4Body: "数据处理基于您的明确同意、预合同措施的执行，以及Eqnovia发展业务的合法利益。",
    s5Title: "5. 数据保留期限",
    s5Body: "联系数据在最后一次沟通后保留3年。浏览数据最多保留13个月。",
    s6Title: "6. 数据接收方",
    s6Body: "数据仅供Eqnovia内部团队使用，不会出售给第三方。某些技术服务提供商（托管、分析服务）可能在其严格职责范围内访问数据，并须遵守保密承诺。",
    s7Title: "7. 您的权利（09-08号法律）",
    s7Body1Prefix: "您有权访问、更正、反对和删除您的数据。如需行使这些权利，请通过以下方式联系我们",
    s7Body2Prefix: "已向CNDP提交声明。如有异议，您也可以向CNDP申诉：",
    s8Title: "8. 安全性",
    s8Body: "Eqnovia采取适当的技术和组织措施（HTTPS加密、访问控制、数据备份），以确保您的数据安全。",
  },
  ar: {
    heading: "سياسة الخصوصية",
    intro: "متوافقة مع القانون 09-08 ولائحة",
    cndpFull: "(اللجنة الوطنية لمراقبة حماية المعطيات ذات الطابع الشخصي).",
    s1Title: "1. المسؤول عن المعالجة",
    s1Body: "شركة Eqnovia، التي يقع مقرها في الدار البيضاء، المغرب، هي المسؤولة عن معالجة البيانات الشخصية التي يتم جمعها عبر هذا الموقع.",
    s2Title: "2. البيانات المجمعة",
    s2Item1: "نموذج الاتصال: الاسم، اللقب، البريد الإلكتروني، الهاتف، الشركة، الرسالة.",
    s2Item2: "بيانات التصفح: عنوان IP مجهول الهوية، الصفحات التي تمت زيارتها، مدة الزيارة.",
    s2Item3Prefix: "ملفات تعريف الارتباط: راجع",
    s2Item3Link: "سياسة ملفات تعريف الارتباط",
    s3Title: "3. الأغراض",
    s3Item1: "الرد على الطلبات التجارية والتقنية.",
    s3Item2: "تحسين تجربة المستخدم وأداء الموقع.",
    s3Item3: "إرسال اتصالات إعلامية بموافقتك.",
    s4Title: "4. الأساس القانوني",
    s4Body: "تستند المعالجة إلى موافقتك الصريحة، وتنفيذ التدابير السابقة للتعاقد، والمصلحة المشروعة لشركة Eqnovia في تطوير نشاطها.",
    s5Title: "5. مدة الاحتفاظ",
    s5Body: "يتم الاحتفاظ ببيانات الاتصال لمدة 3 سنوات بعد آخر تبادل. يتم الاحتفاظ ببيانات التصفح لمدة أقصاها 13 شهرًا.",
    s6Title: "6. المستفيدون",
    s6Body: "البيانات مخصصة حصريًا لفرق Eqnovia الداخلية. لا يتم بيع أي بيانات لأطراف ثالثة. قد يتمكن بعض مزودي الخدمات التقنية (الاستضافة، التحليلات) من الوصول إليها في نطاق مهمتهم الصارم، بموجب التزام بالسرية.",
    s7Title: "7. حقوقك (القانون 09-08)",
    s7Body1Prefix: "لديك الحق في الوصول إلى بياناتك وتصحيحها والاعتراض عليها وحذفها. لممارسة هذه الحقوق، تواصل معنا على",
    s7Body2Prefix: "تم تقديم إقرار لدى اللجنة الوطنية لمراقبة حماية المعطيات ذات الطابع الشخصي. يمكنك أيضًا التوجه إليها في حال وجود خلاف:",
    s8Title: "8. الأمان",
    s8Body: "تنفذ Eqnovia تدابير تقنية وتنظيمية مناسبة (تشفير HTTPS، التحكم في الوصول، النسخ الاحتياطي) لضمان أمان بياناتك.",
  },
} as const;
